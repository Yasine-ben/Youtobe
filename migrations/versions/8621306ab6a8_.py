...
Revision ID: 8621306ab6a8
Revises: 
Create Date: 2023-06-13 22:27:48.511270
...
def upgrade():
    ...
    sa.Column('user_id', sa.Integer(), nullable=True),
    sa.Column('video_id', sa.Integer(), nullable=True),
    sa.Column('reaction_type', sa.Enum('like', 'dislike'), nullable=False),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    my_enum = sa.Enum(name='my_enum_type')
